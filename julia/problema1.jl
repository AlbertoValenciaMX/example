...
for j = 1:d
    ...
    for i = 1:n - 1
        ...
        global TeqF[i] = (91.4 - (91.4 - TenF[j])) * (0.0475 - 0.0203 * VF[i] + 0.304 * sqrt(VF[i]))
        global TeqC[i] = ((91.4 - 32) * 5 / 9 - ((91.4 - 32) * 5 / 9 -TenC[j])) * (0.0475 * 1.60934 - 0.0203 * VC[i] + 0.304 * sqrt(VC[i])) * 9 / 5 + 32
